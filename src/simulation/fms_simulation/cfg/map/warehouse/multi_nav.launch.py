...
def generate_launch_description():
    ...
    robots = [
        # {'name': 'robot_0', 'x_pose': '-3.3325', 'y_pose': '0.6925', 'z_pose': 0.01},
        # {'name': 'robot_1', 'x_pose': '-3.1825', 'y_pose': '-0.5075', 'z_pose': 0.01},

        {'name': 'robot_0', 'x_pose': '12.9563', 'y_pose': '-17.0062', 'z_pose': 0.01},
        {'name': 'robot_1', 'x_pose': '12.7063', 'y_pose': '-10.9062', 'z_pose': 0.01},
        {'name': 'robot_2', 'x_pose': '12.5563', 'y_pose': '-5.2562', 'z_pose': 0.01},
        {'name': 'robot_3', 'x_pose': '12.2563', 'y_pose': '1.2938', 'z_pose': 0.01},
        # {'name': 'robot_4', 'x_pose': '12.2563', 'y_pose': '6.3438', 'z_pose': 0.01},
        # ...
        # ...
    ]
    ...
    fms_gazebo = get_package_share_directory('fms_gazebo')
    ...
    urdf = os.path.join(
        fms_gazebo, 'urdf', 'turtlebot3_' + TURTLEBOT3_MODEL + '.urdf'
    )

    world = os.path.join(
        get_package_share_directory('fms_gazebo'),
    ...
    map_server = Node(package='nav2_map_server',
        ...
        name='map_server',
        output='screen',
        parameters=[{'yaml_filename': os.path.join(get_package_share_directory('turtlebot3_navigation2'), 'map', 'aws_map.yaml'),
                     },],
    ...
    for robot in robots:
        ...
        spawn_turtlebot3_burger = Node(
            ...
            arguments=[
                '-file', os.path.join(fms_gazebo,'models', 'turtlebot3_' + TURTLEBOT3_MODEL, 'model.sdf'),
                '-entity', robot['name'],
    ...
    for robot in robots:
        ...
        initial_pose_cmd = ExecuteProcess(
            cmd=['ros2', 'topic', 'pub', '-t', '3', '--qos-reliability', 'reliable', namespace[0] + '/initialpose',
        ...
        # Perform next rviz and other node instantiation after the previous initialpose request done
