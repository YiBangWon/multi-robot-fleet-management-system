...
def generate_launch_description():
    ...
    robots = [
        {'name': 'carter1', 'x_pose': '-5.3188', 'y_pose': '9.1156', 'z_pose': 0.01},
        {'name': 'carter2', 'x_pose': '-5.3938', 'y_pose': '6.6969', 'z_pose': 0.01},
        {'name': 'carter3', 'x_pose': '-5.4125', 'y_pose': '4.6344', 'z_pose': 0.01},
        {'name': 'carter4', 'x_pose': '-5.3', 'y_pose': '-7.0656', 'z_pose': 0.01},
    ...
    world = os.path.join(
        package_dir, 'worlds', 'no_roof_small_warehouse.world')
    ...
    map_server = Node(package='nav2_map_server',
        ...
        name='map_server',
        output='screen',
        parameters=[{'yaml_filename': os.path.join(get_package_share_directory('fms_simulation'), 'cfg/map/aws','map_image.yaml'),
                     },],
