#!/usr/bin/python3
"""Launch configuration for stage.launch."""
...
def generate_launch_description():
    ...
    # this_directory = get_package_share_directory('fms_server')

    filename_stage_world = LaunchConfiguration('filename_stage_world')
    filename_stage_world_arg = DeclareLaunchArgument('filename_stage_world', default_value='map')

    stage_world_arg = DeclareLaunchArgument('world', default_value=TextSubstitution(text='stage'), description='World file relative to the project world file, without .world')
    ...
    #     file = os.path.join(this_directory,'/cfg/maps/IncheonTP/stage.world')
    ...
    return LaunchDescription([
        ...
        Node(
            ...
            parameters=[{'one_tf_tree': one_tf_tree,
                        ...
                        'world_file': filename_stage_world,
                        'use_sim_time': False
                        }],
        )
    ])
