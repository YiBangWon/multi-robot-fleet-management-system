"""Bring up the server-side stack used during physical robot experiments."""
...
def generate_launch_description():
    ...
    control_board_dir = get_package_share_directory("fms_ctrl_board")
    ...
    return LaunchDescription([
        IncludeLaunchDescription(
            PythonLaunchDescriptionSource(
                os.path.join(control_board_dir, "launch", "fms_ctrl_board.launch.py")
            ),
        ),
        IncludeLaunchDescription(
